 ...
 * program. Which requires users to insert a username and port number.
 * 
 * @author  Group4
 * @version 1.0
 * @since   2023-02-17
...
public class GUILaunch {
    ...
    static void GUIcomponents(){
            ...
            public void actionPerformed(ActionEvent e){
                if(e.getSource() == connectButton){
                        if(enterUsername.getText().equals("")||enterUsername.getText().length()>15){
                            JOptionPane.showMessageDialog(connectButton,"Please enter a valid username","Attention!",JOptionPane.WARNING_MESSAGE);
     ...
     /**
     * This method checks if the input from the port field is indeed 
     * an integer.
     * 
