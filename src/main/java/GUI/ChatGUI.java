...
public class ChatGUI {
    ...
    private static MessageType msgType = MessageType.CHAT;
    private static String receiver = null;

    public ChatGUI(String username, int port) throws UnknownHostException, IOException {
        this.username = username;
        appComponents();
        init();
         clientThread = new ClientThread("localhost", port);
         clientThread.sendMessage(new Message(MessageType.CONNECTION, null, null, username));
         clientThread.Messagelistening(messageArea);
        
    }

    /**
     * This method is used to structure the JFrame in a way which it can fit all
    ...
    /**
     * This method gives each component, a position, size and a design.
     * Then its finally added to the Jframe.
     */
